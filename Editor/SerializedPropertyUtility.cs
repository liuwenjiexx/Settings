...
namespace SettingsManagement.Editor
{
    internal static class SerializedPropertyUtility
    {
        ...
        public static object GetObjectOfProperty(SerializedProperty prop)
        {
        ...
        public static void SetObjectOfProperty(SerializedProperty prop, object value)
        {
        ...
        public static object GetObjectOfPropertyOwner(SerializedProperty prop)
        {
            var path = prop.propertyPath.Replace(".Array.data[", "[");
            object obj = prop.serializedObject.targetObject;
            var elements = path.Split('.');
        ...
        public static GUIContent LabelContent(SerializedProperty property)
        {
